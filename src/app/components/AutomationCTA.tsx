    ...
    <section className="relative py-20 bg-[#007577] overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute top-8 right-8 w-16 h-16 text-yellow-300/20 animate-spin" style={{ animationDuration: '20s' }}>
          <Robot size={64} weight="bold" className="w-full h-full" />
        </div>
      ...
      <div className={`relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
          Transform Your Property with Smart Automation
        </h2>
        
        <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
          Experience the convenience and efficiency of intelligent automation systems. 
          Your smart property journey starts with a free consultation.
        </p>
        ...
        <div className="mt-16 flex flex-col sm:flex-row gap-8 justify-center items-center text-white/80">
          ...
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#E68E27] rounded-full" />
            <span className="text-sm font-regular">Expert Installation</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#E68E27] rounded-full" />
            <span className="text-sm font-regular">24/7 Support</span>
          </div>
        </div>
      </div>
