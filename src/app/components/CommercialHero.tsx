        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="block">Powering Lebanon's</span>
              <span className="block text-[#E68E27]">Businesses</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/90 font-regular mb-4 leading-relaxed">
              Never Lose Power. Never Lose Momentum.
            </p>

            <p className="text-lg text-white/80 mb-8 max-w-lg leading-relaxed">
              iPower's commercial electrical systems help you ensure safety, boost reliability, and power business growth — efficiently.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <span className="relative z-10 text-center">Get a Business Electrical Consultation</span>
