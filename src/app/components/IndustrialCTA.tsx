...
import { Factory, ArrowRight } from '@phosphor-icons/react';
...
const IndustrialCTA = () => {
  ...
  return (
    <section className="relative py-20 bg-[#007577] overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#007577] via-[#007577] to-[#005a5c]" />
        
        <div className="absolute top-8 right-8 w-16 h-16 text-yellow-300/20 animate-spin" style={{ animationDuration: '20s' }}>
          <Factory size={64} weight="bold" className="w-full h-full" />
        </div>
      ...
      <div className={`relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
          Talk to our engineers about scaling your energy independence. 
          Transform your industrial operations with large-scale solar solutions designed for maximum performance and reliability.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          >
            ...
            <span className="relative z-10">Talk to Our Engineers</span>
        ...
        <div className="mt-16 flex flex-col sm:flex-row gap-8 justify-center items-center text-white/80">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-regular">Free Industrial Assessment</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#E68E27] rounded-full" />
            <span className="text-sm font-regular">Engineering Consultation</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#E68E27] rounded-full" />
            <span className="text-sm font-regular">Custom Solutions</span>
          </div>
        </div>
      </div>
