        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="block">Let's Power Something</span>
              <span className="block text-[#E68E27]">Great Together</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/90 font-regular mb-8 leading-relaxed max-w-lg">
              Talk to our engineering team about your project, system upgrade, or consultation — we're ready to help.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <span className="relative z-10 text-center">Get Your Free Consultation</span>
