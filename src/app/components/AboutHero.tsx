        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="block">Engineering Power.</span>
              <span className="block text-[#E68E27]">Designing the Future.</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/90 font-regular mb-8 leading-relaxed max-w-lg">
              Since 2011, iPower has delivered advanced, safe, and sustainable electrical engineering solutions across Lebanon.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <span className="relative z-10 text-center">Explore Our Expertise</span>
